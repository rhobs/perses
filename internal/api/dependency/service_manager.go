...
import (
	...
	dashboardImpl "github.com/rhobs/perses/internal/api/impl/v1/dashboard"
	datasourceImpl "github.com/rhobs/perses/internal/api/impl/v1/datasource"
	ephemeralDashboardImpl "github.com/rhobs/perses/internal/api/impl/v1/ephemeraldashboard"
	folderImpl "github.com/rhobs/perses/internal/api/impl/v1/folder"
	globalDatasourceImpl "github.com/rhobs/perses/internal/api/impl/v1/globaldatasource"
	globalRoleImpl "github.com/rhobs/perses/internal/api/impl/v1/globalrole"
	globalRoleBindingImpl "github.com/rhobs/perses/internal/api/impl/v1/globalrolebinding"
	globalSecretImpl "github.com/rhobs/perses/internal/api/impl/v1/globalsecret"
	globalVariableImpl "github.com/rhobs/perses/internal/api/impl/v1/globalvariable"
	healthImpl "github.com/rhobs/perses/internal/api/impl/v1/health"
	projectImpl "github.com/rhobs/perses/internal/api/impl/v1/project"
	roleImpl "github.com/rhobs/perses/internal/api/impl/v1/role"
	roleBindingImpl "github.com/rhobs/perses/internal/api/impl/v1/rolebinding"
	secretImpl "github.com/rhobs/perses/internal/api/impl/v1/secret"
	userImpl "github.com/rhobs/perses/internal/api/impl/v1/user"
	variableImpl "github.com/rhobs/perses/internal/api/impl/v1/variable"
	viewImpl "github.com/rhobs/perses/internal/api/impl/v1/view"
	...
	"github.com/rhobs/perses/internal/api/interface/v1/folder"
	"github.com/rhobs/perses/internal/api/interface/v1/globaldatasource"
	...
	"github.com/rhobs/perses/internal/api/interface/v1/globalsecret"
	...
	"github.com/rhobs/perses/internal/api/interface/v1/secret"
	"github.com/rhobs/perses/internal/api/interface/v1/user"
	"github.com/rhobs/perses/internal/api/interface/v1/variable"
...
func newServiceManager(dao PersistenceManager, conf config.Config) (ServiceManager, error) {
	...
	dashboardService := dashboardImpl.NewService(conf, dao.GetDashboard(), dao.GetGlobalVariable(), dao.GetVariable(), schemaService, authzService)
