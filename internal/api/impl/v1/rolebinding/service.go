...
func (s *service) RawList(q *rolebinding.Query) ([]json.RawMessage, error) {
	return s.dao.RawList(q)
}

func (s *service) MetadataList(q *rolebinding.Query) ([]api.Entity, error) {
	return s.dao.MetadataList(q)
}

func (s *service) RawMetadataList(q *rolebinding.Query) ([]json.RawMessage, error) {
