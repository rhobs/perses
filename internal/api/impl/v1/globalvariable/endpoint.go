...
func NewEndpoint(cfg config.VariableConfig, service globalvariable.Service, rbacService rbac.RBAC, securityService crypto.Security, readonly bool, caseSensitive bool) route.Endpoint {
	return &endpoint{
		toolbox:   toolbox.New[*v1.GlobalVariable, *v1.GlobalVariable, *globalvariable.Query](service, rbacService, securityService, v1.KindGlobalVariable, caseSensitive),
		readonly:  readonly,
