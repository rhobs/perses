...
func NewEndpoint(service folder.Service, rbacService rbac.RBAC, securityService crypto.Security, readonly bool, caseSensitive bool) route.Endpoint {
	return &endpoint{
		toolbox:  toolbox.New[*v1.Folder, *v1.Folder, *folder.Query](service, rbacService, securityService, v1.KindFolder, caseSensitive),
		readonly: readonly,
	}
}
