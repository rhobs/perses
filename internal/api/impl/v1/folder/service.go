...
func (s *service) List(q *folder.Query) ([]*v1.Folder, error) {
	return s.dao.List(q)
}

func (s *service) RawList(q *folder.Query) ([]json.RawMessage, error) {
	return s.dao.RawList(q)
}

func (s *service) MetadataList(q *folder.Query) ([]api.Entity, error) {
	return s.dao.MetadataList(q)
}

func (s *service) RawMetadataList(q *folder.Query) ([]json.RawMessage, error) {
