...
func NewEndpoint(service dashboard.Service, rbacService rbac.RBAC, securityService crypto.Security, readonly bool, caseSensitive bool) route.Endpoint {
	return &endpoint{
		toolbox:  toolbox.New[*v1.Dashboard, *v1.Dashboard, *dashboard.Query](service, rbacService, securityService, v1.KindDashboard, caseSensitive),
		readonly: readonly,
	}
}
