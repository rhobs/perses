...
func NewEndpoint(cfg config.VariableConfig, service variable.Service, rbacService rbac.RBAC, securityService crypto.Security, readonly bool, caseSensitive bool) route.Endpoint {
	return &endpoint{
		toolbox:   toolbox.New[*v1.Variable, *v1.Variable, *variable.Query](service, rbacService, securityService, v1.KindVariable, caseSensitive),
		readonly:  readonly,
