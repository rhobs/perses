...
func TestListWithPathTraversalInProjectQueryParam(t *testing.T) {
	e2eframework.WithServer(t, func(_ *httptest.Server, expect *httpexpect.Expect, manager dependency.PersistenceManager) []api.Entity {
		...
		e2eframework.CreateAndWaitUntilEntitiesExist(t, manager, firstProject, secondProject, firstVariable, secondVariable)
...
func TestListWithPathTraversalInProjectQueryParamWithMetadataOnly(t *testing.T) {
	e2eframework.WithServer(t, func(_ *httptest.Server, expect *httpexpect.Expect, manager dependency.PersistenceManager) []api.Entity {
		...
		e2eframework.CreateAndWaitUntilEntitiesExist(t, manager, project, variable)
