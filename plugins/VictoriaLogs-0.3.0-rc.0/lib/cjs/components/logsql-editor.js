...
Object.defineProperty(exports, "LogsQLEditor", {
    enumerable: true,
    get: function() {
        return LogsQLEditor;
    }
...
const _logsqlextension = require("./logsql-extension");
...
function LogsQLEditor(props) {
    const theme = (0, _material.useTheme)();
    const isDarkMode = theme.palette.mode === 'dark';
    const logsqlExtension = (0, _react.useMemo)(()=>{
        return (0, _logsqlextension.LogsQLExtension)();
    }, []);
