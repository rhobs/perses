...
import { getTablePanelQueryOptions, TableCellsEditor, TableColumnsEditor, TablePanel, TableSettingsEditor, TableTransformsEditor } from './components';
    ...
    panelOptionsEditorComponents: [
        {
            ...
            content: TableSettingsEditor
        },
        {
            label: 'Column Settings',
            content: TableColumnsEditor
        },
        {
            label: 'Cell Settings',
            content: TableCellsEditor
        },
        {
            label: 'Transforms',
            content: TableTransformsEditor
        },
        {
            label: 'Item Actions',
            content: TableItemSelectionActionsEditor
        }
    ],
