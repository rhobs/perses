...
import { YAxisLabel, useChartsTheme, ContentWithLegend, useId, DEFAULT_TOOLTIP_CONFIG, getFormattedMultipleYAxes } from '@perses-dev/components';
            ...
            if (result) {
                for(let i = 0; i < result.data.series.length; i++){
                    ...
                    if (showTimeSeries) {
                        ...
                        timeSeriesMapping.push(getTimeSeries(seriesId, datasetIndex, formattedSeriesName, visual, timeScale, seriesColor, querySettings, yAxisIndex));
