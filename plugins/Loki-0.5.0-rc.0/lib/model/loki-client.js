...
export async function query(params, options) {
...
export function toUnixSeconds(val) {
...
export async function queryRange(params, options) {
...
export async function labels(start, end, options) {
...
export async function labelValues(label, start, end, options) {
...
export async function series(match, start, end, options) {
...
export async function volume(params, options) {
...
export async function volumeRange(params, options) {
...
export async function indexStats(query, start, end, options) {
...
//# sourceMappingURL=loki-client.js.map