...
The CLI is available in the archives created at each [release](https://github.com/rhobs/perses/releases), as well as in the [docker images](https://hub.docker.com/r/persesdev/perses/tags).
